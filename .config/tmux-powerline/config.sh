...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="famicom-retro"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/Angel/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/Angel"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/Angel/.mailcheckrc"
...
# Mode of roll text {"space", "repeat"}. space: fill up with empty space; repeat: repeat text from beginning
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/Angel/.now_playing.log"
